...
Step 1
---
Disabled the hardware checksum offload, hardware TCP segmentation offload, hardware large receive offload (this is recommended by OPNsense)
...
Step 3
---
Created a rule file to alert of any Nmap scan on the OPNsense firewall's IP
